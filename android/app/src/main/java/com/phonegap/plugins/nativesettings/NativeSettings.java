...
public class NativeSettings extends CordovaPlugin {
    ...
    public boolean execute(String action, JSONArray args, CallbackContext callbackContext) throws JSONException {
        ...
        //}
            ...
            intent = new Intent(Settings.ACTION_CAPTIONING_SETTINGS);
            ...
            intent = new Intent(Settings.ACTION_NFC_PAYMENT_SETTINGS);
        ...
        //}
            ...
            intent = new Intent(Settings.ACTION_SHOW_REGULATORY_INFO);
